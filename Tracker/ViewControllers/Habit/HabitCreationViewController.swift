...
final class HabitCreationViewController: UIViewController {
    ...
    private var charLabelHeightConstraint: NSLayoutConstraint!
    ...
    private lazy var trackerNameTextField: UITextField = {
        ...
        textField.backgroundColor = .ypBackgorund
    ...
    private func setupLayoutAndConstraints() {
        ...
        charLabelHeightConstraint = charLimitsLabel.heightAnchor.constraint(equalToConstant: 0)
    ...
    private func createButtonDidTapped() {
        ...
        let newTracker = Tracker(id: UUID(), name: text, emoji: "🤡", schedule: selectedDays, color: .ypColorSelection1)
